...
const items = [
  {
    ...
    Icon: InstagramIcon,
    className: 'bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 text-white border-0 hover:opacity-90',
  },
  {
    key: 'facebook',
    ...
    Icon: FacebookIcon,
    className: 'bg-[#1877F2] text-white border-0 hover:opacity-90',
  },
  {
    key: 'whatsapp',
    ...
    Icon: WhatsAppIcon,
    className: 'bg-[#25D366] text-white border-0 hover:opacity-90',
  },
] as const;
